...
const Navbar = () => {
  ...
  return (
    <div className='flex fixed top-0 justify-between z-4 items-start w-full '>
      <div className='lg:p-3 p-2'>
    
        <div 
        className='bg-transparent lg:w-36 w-20'>
      ...
      <div
        ...
        className='lg:h-12 h-12 w-28 lg:w-[16.5vw] relative bg-black'
      >
        <div className='relative'> </div>
        <div ref={navGreenRef} className='bg-green-400 h-0 w-full absolute top-0 transition-all'></div>
